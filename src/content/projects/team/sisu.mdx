...
My role in SISU was as a backend developer and researcher. To find all the chains APIs from which we can extract the useful information from it and utilize them. To find how to integrate different chain wallets with SISU.
